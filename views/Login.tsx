    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-[#F2F9F6] to-emerald-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-emerald-100">
          ...
          <button
            onClick={() => {/* Google Sign-in not yet implemented */}}
            className="w-full bg-white hover:bg-gray-50 text-gray-900 py-4 rounded-xl font-bold text-lg transition-colors border border-gray-300 flex items-center justify-center gap-3 mb-6"
          >
